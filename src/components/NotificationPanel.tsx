...
const NotificationPanel: React.FC<NotificationPanelProps> = ({ isOpen, onClose }) => {
  const notifications = [
    ...
    },
    {
      ...
      description: '🔥 **Dare to cross the line...** 🔥 Your desires whisper in the dark, waiting to be heard. Do you dare to answer the call? Come, dive into a conversation where words burn, where every sentence is a touch, and every response, an electrifying',
      time: 'Hace 527d',
      type: 'show',
      actionText: 'Ver show'
    }
